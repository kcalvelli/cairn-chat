...
- Affected code:
  - `pkgs/cairn-ai-bot/src/cairn_ai_bot/llm/anthropic.py` (removed, replaced by `gemini.py`)
  - `pkgs/cairn-ai-bot/src/cairn_ai_bot/llm/__init__.py` (factory update)
  - `pkgs/cairn-ai-bot/src/cairn_ai_bot/llm/base.py` (no change)
  - `pkgs/cairn-ai-bot/src/cairn_ai_bot/llm/prompts.py` (remove router template)
  - `pkgs/cairn-ai-bot/src/cairn_ai_bot/domains.py` (removed)
  - `pkgs/cairn-ai-bot/src/cairn_ai_bot/router.py` (simplified, domain routing removed)
  - `pkgs/cairn-ai-bot/src/cairn_ai_bot/main.py` (config key rename)
  - `pkgs/cairn-ai-bot/src/cairn_ai_bot/media.py` (add Gemini content block format)
  - `pkgs/cairn-ai-bot/src/cairn_ai_bot/tools.py` (remove `format_tools_for_claude`, add `format_tools_for_gemini`)
  - `pkgs/cairn-ai-bot/pyproject.toml` (swap `anthropic` for `google-genai`)
