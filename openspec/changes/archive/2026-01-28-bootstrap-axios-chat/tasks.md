...
- [x] 1.1.5 Export packages.${system}.axios-ai-bot
...
- [x] 1.2.3 Create `pkgs/axios-ai-bot/` directory
...
- [x] 1.3.4 Add CODE_OF_ETHICS.md (copy from axios ecosystem)

## Phase 2: Prosody NixOS Module

### 2.1 Module Structure
- [x] 2.1.1 Create `modules/nixos/prosody.nix` with option definitions
- [x] 2.1.2 Define `services.axios-chat.prosody.enable` option
- [x] 2.1.3 Define `services.axios-chat.prosody.domain` option
- [x] 2.1.4 Define `services.axios-chat.prosody.tailscaleIP` option
- [x] 2.1.5 Define `services.axios-chat.prosody.admins` option
- [x] 2.1.6 Define `services.axios-chat.prosody.muc.*` options
...
## Phase 3: axios-ai-bot Python Package

### 3.1 Package Setup
- [x] 3.1.1 Create `pkgs/axios-ai-bot/pyproject.toml`
- [x] 3.1.2 Define dependencies: slixmpp, anthropic, httpx, pydantic
- [x] 3.1.3 Create `pkgs/axios-ai-bot/src/axios_ai_bot/__init__.py`
- [x] 3.1.4 Create package build in flake.nix using buildPythonApplication
- [x] 3.1.5 Verify package builds with `nix build .#axios-ai-bot`

### 3.2 XMPP Client Module
- [x] 3.2.1 Create `src/axios_ai_bot/xmpp.py`
...
- [x] 3.3.1 Create `src/axios_ai_bot/tools.py`
...
- [x] 3.4.1 Create `src/axios_ai_bot/router.py`
...
- [x] 3.5.1 Create `src/axios_ai_bot/llm.py`
...
- [x] 3.6.1 Create `src/axios_ai_bot/main.py`
...
- [x] 4.1.2 Define `services.axios-chat.bot.enable` option
- [x] 4.1.3 Define `services.axios-chat.bot.xmppUser` option (default: "ai")
- [x] 4.1.4 Define `services.axios-chat.bot.xmppDomain` option
- [x] 4.1.5 Define `services.axios-chat.bot.xmppPasswordFile` option
- [x] 4.1.6 Define `services.axios-chat.bot.anthropicKeyFile` option
- [x] 4.1.7 Define `services.axios-chat.bot.mcpGatewayUrl` option (default: "http://localhost:8085")
- [x] 4.1.8 Define `services.axios-chat.bot.toolRefreshInterval` option (default: 300)
- [x] 4.1.9 Define `services.axios-chat.bot.systemPromptFile` option
...
- [x] 4.2.6 Reference axios-ai-bot package in ExecStart
...
- [x] 6.1.2 Define `programs.axios-chat.enable` option
- [x] 6.1.3 Define `programs.axios-chat.defaultAccount` option
...
- [ ] 7.2.1 Add axios-chat as input to axios flake
- [ ] 7.2.2 Import module in axios configuration
...
- Phase 3: axios-ai-bot Python Package ✅ (unit tests deferred)
